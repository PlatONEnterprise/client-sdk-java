...
public class SophiaFunctionWrapper extends Generator {
    ...
    public void generateJavaFiles(
            String contractName, File binaryFile, String abi, String destinationDir,
            String basePackageName)
            throws IOException, ClassNotFoundException {
        generateJavaFiles(contractName, binaryFile, abi,
    ...
    void generateJavaFiles(
        ...
        TypeSpec.Builder classBuilder = createClassBuilder(className, binaryFile, abi);
    ...
    private TypeSpec.Builder createClassBuilder(String className, File binaryFile, String abi) {
        ...
        return TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC)
                .addJavadoc(javadoc)
                .superclass(PlatOneContract.class)
    ...
    Iterable<FieldSpec> buildFuncNameConstants(List<AbiDefinition> functionDefinitions) {
        ...
        fieldNames.add(PlatOneContract.FUNC_DEPLOY);
    ...
    private static MethodSpec buildGetInvokeData(String functionName) {
        ...
        toReturn.addStatement("return $T.invokeEncode($L,getTransactionType($L))", PlatOneUtil.class,functionName,functionName);
        return toReturn.build();
    }
    ...
    private static MethodSpec buildGetDeployData() {
        ...
        toReturn.addStatement("return $T.deployEncode($L, $L)",PlatOneUtil.class,CONTRACT_BINARY,ABI);
        return toReturn.build();
    }
    ...
    private static MethodSpec buildGetDeployGasLimit() {
        ...
        toReturn.addStatement("return $T.estimateGasLimit($L, $L, $L, getDeployData($L))",PlatOneUtil.class,WEB3J,ESTIMATE_GAS_FROM,ESTIMATE_GAS_TO,CONTRACT_BINARY);
        return toReturn.build();
    }
    ...
    private MethodSpec buildTransactionFunctionData(AbiDefinition functionDefinition) {
        ...
        methodBuilder.addStatement("return $T.invokeEncode(function,customTransactionType(function))",PlatOneUtil.class);
        return methodBuilder.build();
    ...
    private MethodSpec buildTransactionFunctionGasLimit(AbiDefinition functionDefinition) {
        ...
        if (!functionDefinition.isConstant()) {
            ...
            methodBuilder.addStatement("return $T.estimateGasLimit($L,$L,$L,ethEstimateGasData)",PlatOneUtil.class,WEB3J,ESTIMATE_GAS_FROM,ESTIMATE_GAS_TO);
            return methodBuilder.build();
        }
        return null;
    }
        ...
        TypeSpec converter = TypeSpec.anonymousClassBuilder("")
                ...
                .addMethod(MethodSpec.methodBuilder("call")
                        ...
                        .addStatement("$T eventValues = extractEventParametersWithLog("
                                ...
                                PlatOneContract.EventValuesWithLog.class)
