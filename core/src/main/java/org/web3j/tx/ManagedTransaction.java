...
public abstract class ManagedTransaction {
    ...
    protected TransactionReceipt send(
        String to, String data, BigInteger value, BigInteger gasPrice, BigInteger gasLimit, BigInteger txType)
        throws IOException, TransactionException {

        return transactionManager.executeTransaction(
            gasPrice, gasLimit, to, data, value, txType);
    }
    protected TransactionReceipt sendWithNonce(
        String to, String data, BigInteger value, BigInteger gasPrice, BigInteger gasLimit, BigInteger nonce)
        throws IOException, TransactionException {

        return transactionManager.executeTransactionWithNonce(
            gasPrice, gasLimit, to, data, value,nonce);
    }
    protected TransactionReceipt sendWithNonce(
        String to, String data, BigInteger value, BigInteger gasPrice, BigInteger gasLimit, BigInteger nonce, BigInteger txType)
        throws IOException, TransactionException {

        return transactionManager.executeTransactionWithNonce(
            gasPrice, gasLimit, to, data, value,nonce,txType);
    }
}
