...
public class ClientTransactionManager extends TransactionManager {
    ...
    public EthSendTransaction sendTransaction(
            BigInteger gasPrice, BigInteger gasLimit, String to,
            String data, BigInteger value, BigInteger txType)
            throws IOException {

        Transaction transaction = new Transaction(
                getFromAddress(), null, gasPrice, gasLimit, to, value, data,txType);
    ...
    public EthSendTransaction sendTransactionWithNonce(
            BigInteger gasPrice, BigInteger gasLimit, String to,
            String data, BigInteger value, BigInteger nonce, BigInteger txType)
            throws IOException {

        Transaction transaction = new Transaction(
                getFromAddress(), nonce, gasPrice, gasLimit, to, value, data,txType);
