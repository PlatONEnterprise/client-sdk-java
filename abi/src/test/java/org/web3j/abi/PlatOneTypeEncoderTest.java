...
public class PlatOneTypeEncoderTest {


    @Test
    public void testUintEncode() {
        Uint zero = new Uint64(BigInteger.ZERO);
        assertThat(PlatOneTypeEncoder.encode(zero),
                is("0000000000000000"));

        Uint maxLong = new Uint64(BigInteger.valueOf(Long.MAX_VALUE));
        assertThat(PlatOneTypeEncoder.encode(maxLong),
                is("7fffffffffffffff"));
    }
    ...
    public void testIntEncode() {
        ...
        assertThat(PlatOneTypeEncoder.encode(minLong),
                is("8000000000000000"));

        Int minusOne = new Int64(BigInteger.valueOf(-1));
        assertThat(PlatOneTypeEncoder.encode(minusOne),
                is("ffffffffffffffff"));
    }
    ...
    public void testUtf8String() {
        ...
        assertThat(PlatOneTypeEncoder.encode(string),
